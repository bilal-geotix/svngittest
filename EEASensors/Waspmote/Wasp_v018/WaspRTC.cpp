...
char* WaspRTC::getTimestamp() 
{
  char* aux="\0                                                " ;
  switch (day) {
	case 1:		sprintf (aux, "%s, %02d/%02d/%02d - %02d:%02d.%02d", DAY_1, year, month, date, hour, minute, second);
			break;
	case 2:		sprintf (aux, "%s, %02d/%02d/%02d - %02d:%02d.%02d", DAY_2, year, month, date, hour, minute, second);
			break;
	case 3:		sprintf (aux, "%s, %02d/%02d/%02d - %02d:%02d.%02d", DAY_3, year, month, date, hour, minute, second);
			break;
	case 4:		sprintf (aux, "%s, %02d/%02d/%02d - %02d:%02d.%02d", DAY_4, year, month, date, hour, minute, second);
			break;
	case 5:		sprintf (aux, "%s, %02d/%02d/%02d - %02d:%02d.%02d", DAY_5, year, month, date, hour, minute, second);
			break;
	case 6:		sprintf (aux, "%s, %02d/%02d/%02d - %02d:%02d.%02d", DAY_6, year, month, date, hour, minute, second);
			break;
	case 7:		sprintf (aux, "%s, %02d/%02d/%02d - %02d:%02d.%02d", DAY_7, year, month, date, hour, minute, second);
			break;
  }
  return aux;
}
