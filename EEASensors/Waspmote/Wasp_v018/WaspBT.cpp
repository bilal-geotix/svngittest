...
int8_t WaspBT::parse_data(const char* answer)
{
...
int8_t WaspBT::pin_request(uint8_t* data, uint8_t pin_en)
{
...
int8_t WaspBT::accept_connection(uint8_t* data)
{
	char* command = (char*) calloc(50,sizeof(char));
	if( command==NULL ) return -1;
...
int8_t WaspBT::setSecurity(uint8_t mode, const char* pin)
{
	char* command = (char*) calloc(50,sizeof(char));
	if( command==NULL ) return -1;
	uint8_t length=0;
...
// Returns '0' if no error, '>0' otherwise
int8_t WaspBT::setPublicName(const char* name)
{	
	char* command = (char*) calloc(50,sizeof(char));
	if( command==NULL ) return -1;
	uint8_t length=0;
...
// Returns '0' if no error, '>0' otherwise
int8_t WaspBT::setAutoAccept(uint8_t mode)
{
	char* command = (char*) calloc(50,sizeof(char));
	if( command==NULL ) return -1;
	uint8_t error=0;
...
// Returns '0' if no error, '>0' otherwise
int8_t WaspBT::setDiscoveryOptions(uint8_t option)
{
	char* command = (char*) calloc(50,sizeof(char));
	if( command==NULL ) return -1;
	uint8_t error=0;
...
int8_t WaspBT::setServiceParameters(const char* name, uint8_t channel, const char* cod)
{
	char* command = (char*) calloc(50,sizeof(char));
	if( command==NULL ) return -1;
	uint8_t length=0;
...
int8_t WaspBT::discoverDevice(const char* mac, const char* profile)
{
	char* command = (char*) calloc(50,sizeof(char));
	if( command==NULL ) return -1;
	uint8_t error=0;
...
int8_t WaspBT::createConnection(const char* mac,const char* channel)
{
	char* command = (char*) calloc(50,sizeof(char));
	if( command==NULL ) return -1;
	uint8_t error=0;
...
int8_t WaspBT::removeTrustedDevice(const char* mac)
{
	char* command = (char*) calloc(50,sizeof(char));
	if( command==NULL ) return -1;
	uint8_t error=0;
...
int8_t WaspBT::sendData(const char* data)
{
	uint16_t length=0;
	uint8_t error=0;
