...
class WaspBT
{
	 ...
	 */
	int8_t parse_data(const char* answer);
	...
	\return '-1' if memory error, '0' on match with answer, '1' on mismatch with answer, '2' no char received with answer, '3' no error without answer, '4' no char received without answer
	 */
	int8_t pin_request(uint8_t* data,uint8_t pin_en);
	...
	\return '-1' if memory error, '0' on match with answer, '1' on mismatch with answer, '2' no char received with answer, '3' no error without answer, '4' no char received without answer
	 */
	int8_t accept_connection(uint8_t* data);
	...
	\return '-1' if memory error, '0' on match with answer, '1' on mismatch with answer, '2' no char received with answer, '3' no error without answer, '4' no char received without answer
	 */
	int8_t setSecurity(uint8_t mode, const char* pin);
	...
	\return '-1' if memory error, '0' on match with answer, '1' on mismatch with answer, '2' no char received with answer, '3' no error without answer, '4' no char received without answer
	 */
	int8_t setPublicName(const char* name);
	...
	\return '-1' if memory error, '0' on match with answer, '1' on mismatch with answer, '2' no char received with answer, '3' no error without answer, '4' no char received without answer
	 */
	int8_t setAutoAccept(uint8_t mode);
	...
	\return '-1' if memory error, '0' on match with answer, '1' on mismatch with answer, '2' no char received with answer, '3' no error without answer, '4' no char received without answer
	 */
	int8_t setDiscoveryOptions(uint8_t option);
	...
	\return '-1' if memory error, '0' on match with answer, '1' on mismatch with answer, '2' no char received with answer, '3' no error without answer, '4' no char received without answer
	 */
	int8_t setServiceParameters(const char* name, uint8_t channel, const char* cod);
	...
	\return '-1' if memory error, '0' on match with answer, '1' on mismatch with answer, '2' no char received with answer, '3' no error without answer, '4' no char received without answer
	 */
	int8_t discoverDevice(const char* mac, const char* profile);
	...
	\return '-1' if memory error, '0' on match with answer, '1' on mismatch with answer, '2' no char received with answer, '3' no error without answer, '4' no char received without answer
	 */
	int8_t createConnection(const char* mac,const char* channel);
	...
	\return '-1' if memory error, '0' on match with answer, '1' on mismatch with answer, '2' no char received with answer, '3' no error without answer, '4' no char received without answer
	 */
	int8_t removeTrustedDevice(const char* mac);
