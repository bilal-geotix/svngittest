...
public class EeaDataTransfer {
	 ...
	 * @throws IOException
	 */
	private StationCollection parseData(String file) throws XMLStreamException, IOException {
	 ...
	 * @throws IOException
	 */
	private void initializeDatabase(ArrayList<Station> stats) throws ClassNotFoundException, IOException {
		dba.connect();
		try {
	 ...
	 * @throws SQLException
	 */
	private void insertObservations(StationCollection stats) throws ClassNotFoundException, SQLException {
		System.out.println("insertObservations");
		dba.connect();
...
//					}
	 ...
	 * @throws ClassNotFoundException
	 */
	private void parseAndInitialize(String file) throws XMLStreamException, IOException, ClassNotFoundException {
		System.out.println("parseAndInitialize");
	 ...
	 * @throws IOException
	 */
	private void parseAndObservations(String file) throws ClassNotFoundException, SQLException, XMLStreamException, IOException {
		System.out.println("parseAndObservations " + file);
	 ...
	 * @throws IOException
	 */
	private void refreshSOS(String urls) throws IOException {
	 ...
	 * @param count
	 */
	private void moveParsedFiles(String srcDir, String destDir, int count) {
	 ...
	 * @param count
	 */
	private void piFromDir(String file, int count) {
	 ...
	 */
	private void poFromDir(String file, int count) {
	 ...
	 * @param count
	 */
	private void pioFromDir(String file, int count) {
		System.out.println("pioFromDir");
		if (count == 0) {
			count = this.transFiles.length;
		}
	...
	public static void main (String[] args) throws SQLException, IOException {
		...
		if (args.length == 0) {				
			edt = new EeaDataTransfer("X:/sos_maidens/sos_testdata", "jdbc:postgresql://hare:5432/SosDatabase", "postgres", "Anders1and");
			System.out.println("Specify file name or directory");
			String d = "X:/sos_maidens/sos_testdata";
